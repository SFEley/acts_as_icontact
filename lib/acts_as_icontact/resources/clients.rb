module ActsAsIcontact
  # The nested Client Folders resource from iContact.  Currently only supports retrieval -- and is 
  ...
  def self.client_id
    @client_id ||= Clients.first["clientFolderId"].to_i
  end
